...
Esta extensión depende totalmente de mi otro script, **[DowP]([https://github.com/MarckDP/DowP_Downloader](https://github.com/MarckDP/DowP_Importer-Adobe/blob/main/Manual%20del%20DowP.md))** (ya viene incluido en los archivos de la extensión), que está un poco modificado para conectarse a esta extensión mediante un servidor interno.
